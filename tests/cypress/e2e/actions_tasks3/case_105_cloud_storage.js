...
context('Cloud storage.', () => {
    ...
    describe(`Testing case "${caseId}"`, () => {
        it('Check "Cloud Storage" page.', () => {
            ...
            cy.get('.cvat-cloud-storage-form')
                .should('be.visible')
                .within(() => {
        ...
        it('Check "AWS S3" provider fields.', () => {
            cy.get('#display_name').type(dummyData.display_name).should('have.attr', 'value', dummyData.display_name);
        ...
        it('Check "Google cloud storage" provider fields.', () => {
            ...
            cy.get('#resource').should('exist').should('have.attr', 'value', dummyData.resource);
            cy.get('#credentials_type').should('exist').click();
            cy.get('.ant-select-dropdown')
                .not('.ant-select-dropdown-hidden')
                .get('[title="Key file"]')
        ...
        it('Check select files from "Cloud Storage" when creating a task.', () => {
            ...
            cy.get('.cvat-create-task-content')
                .should('be.visible')
                .within(() => {
